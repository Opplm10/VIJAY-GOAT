...
# Others
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002220959471').split()]
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', "-1002188839098"))
